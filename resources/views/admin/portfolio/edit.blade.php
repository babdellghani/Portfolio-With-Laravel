                            ...
                            <form method="post" action="{{ route('portfolio.update', $portfolio) }}" class="mt-4"
                                ...
                                <div class="mb-3">
                                    ...
                                    <x-text-input id="link" name="link" type="url" class="form-control"
                                        :value="old('link', $portfolio->link)" placeholder="https://example.com" required autocomplete="url" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="square-switch">
                                        <input type="checkbox" id="square-switch3" value="1" switch="bool"
                                            name="status" @checked(old('status', $portfolio->status)) />
                                ...
                                <div class="mb-3">
                                    ...
                                    <x-text-input id="category" name="category" type="text" class="form-control"
                                        :value="old(
                                            'category',
                                            is_array($portfolio->category)
                                                ? implode(', ', $portfolio->category)
                                                : $portfolio->category,
                                        )"
