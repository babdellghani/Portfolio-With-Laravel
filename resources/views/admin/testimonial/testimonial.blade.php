                ...
                <div class="card shadow-sm rounded">
                    <div class="card-body">
                        <section class="mb-4">
                            ...
                            <form method="post" action="{{ route('testimonial.store') }}" class="mt-4"
                                ...
                                <div class="mb-3">
                                    ...
                                    <x-text-input id="name" name="name" type="text" class="form-control"
                                        :value="old('name')" placeholder="Client Name" required autofocus
                                        autocomplete="name" />
                                                ...
                                                <tbody>
                                                    @foreach ($testimonials as $testimonial)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="display">{{ $testimonial->title ?? 'N/A' }}</span>
                                                            </td>
                                                            <td>
                                                                <span class="display">
                                                                    @for ($i = 1; $i <= 5; $i++)
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="display">{{ Str::limit($testimonial->message, 50) }}</span>
                                                            </td>
                                                            <td>
                                                                <form
                                                                    action="{{ route('testimonial.status', $testimonial) }}"
