                    ...
                    <div class="about__info__wrap">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="about" role="tabpanel"
                                ...
                                <p class="desc">There are many variations of passages of Lorem Ipsum available, but the
                                ...
                                <ul class="about__exp__list">
                                    <li>
                                        ...
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority
                                            ...
                                            which dont look even slightly believable. If you are going to unseery.</p>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority
                                            have suffered alteration in some form, by injected humour, or randomised words
                                            which dont look even slightly believable.</p>
                                    </li>
                                </ul>
                            </div>
